...
public class Client implements Serializable{
	...
	private String clientsRemark = null;
	private String dealersRemark = null;	
	private String representativesRemark = null;
    ...
    private String userType = AppConstant.LOGIN_USER_TYPE_CLIENT;
	...
	public String getClientsRemark() {
		return clientsRemark;
	}
	public void setClientsRemark(String clientsRemark) {
		this.clientsRemark = clientsRemark;
	}
	public String getDealersRemark() {
		return dealersRemark;
	}
	public void setDealersRemark(String dealersRemark) {
		this.dealersRemark = dealersRemark;
	}
	public String getRepresentativesRemark() {
		return representativesRemark;
	}
	public void setRepresentativesRemark(String representativesRemark) {
		this.representativesRemark = representativesRemark;
	}
	...
	public String toString() {
		return "Client [shopId=" + shopId + ", shopName=" + shopName
				+ ", state=" + state + ", city=" + city + ", district="
				+ district + ", lane=" + lane + ", shopNumber=" + shopNumber
				+ ", pincode=" + pincode + ", personName=" + personName
				+ ", contactInfo=" + contactInfo + ", isb=" + isb + ", gsb="
				+ gsb + ", clientsRemark=" + clientsRemark + ", dealersRemark="
				+ dealersRemark + ", representativesRemark="
				+ representativesRemark + ", isbClarification="
