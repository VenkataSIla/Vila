...
public class Representative implements Serializable {
    ...
    private String userType = AppConstant.LOGIN_USER_TYPE_REPRESENTATIVE;
	...
	public String toString() {
		return "Representative [id=" + id + ", shopId=" + shopId
				+ ", shopName=" + shopName + ", state=" + state + ", city="
				+ city + ", district=" + district + ", lane=" + lane
				+ ", shopNumber=" + shopNumber + ", pincode=" + pincode
				+ ", personName=" + personName + ", contactInfo=" + contactInfo
				+ ", isb=" + isb + ", gsb=" + gsb + ", clientRemark="
				+ clientRemark + ", dealerRemark=" + dealerRemark
				+ ", isbClarification=" + isbClarification
				+ ", isbBoardSizeLength=" + isbBoardSizeLength
				+ ", isbBoardSizeHeight=" + isbBoardSizeHeight
				+ ", isbPhotoFile=" + isbPhotoFile + ", isbPhotoFlag="
				+ Arrays.toString(isbPhotoFlag) + ", gbsClarification="
				+ gbsClarification + ", gbsBoardSizeLength="
				+ gbsBoardSizeLength + ", gbsBoardSizeHeight="
				+ gbsBoardSizeHeight + ", gbsPhotoFile=" + gbsPhotoFile
				+ ", gbsPhotoFlag=" + Arrays.toString(gbsPhotoFlag)
				+ ", representativeRemark=" + representativeRemark
				+ ", userType=" + userType + ", name=" + name + ", createdBy="
