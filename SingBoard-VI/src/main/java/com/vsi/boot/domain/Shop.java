...
public class Shop implements Serializable{
	...
	public String toString() {
		return "Shop [shopId=" + shopId + ", shopName=" + shopName + ", state="
				+ state + ", city=" + city + ", district=" + district
				+ ", lane=" + lane + ", shopNumber=" + shopNumber
				+ ", pincode=" + pincode + ", personName=" + personName
				+ ", contactInfo=" + contactInfo + ", isb=" + isb + ", gsb="
				+ gsb + ", clientRemark=" + clientRemark + ", dealerRemark="
				+ dealerRemark + ", isbClarification=" + isbClarification
